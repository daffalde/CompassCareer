    ...
    <>
      <div className="container">
        ...
        <div className="tersimpan-body">
          {halaman === "lowongan" ? (
            <>
              <h4 className="heading-page">Lowongan Tersimpan</h4>
              <br />
              <div className="t-b-lowongan-wrap">
                {!loading ? (
                  ...
                  Array.from({ length: 6 }).map((_, i) => (
                    <Skeleton key={i} width={"100%"} height={"320px"} />
                  ))
                )}
              </div>
              <br />
            ...
            <>
              {select2 !== null ? (
                <button onClick={() => setSelect2(null)} className="side-back">
                  <img src="/left-arrow.png" alt="back icon" />
                  <p>Kembali</p>
                </button>
              ) : null}
              ...
              <h4 className="heading-page">Perusahaan Tersimpan</h4>
              <br />
