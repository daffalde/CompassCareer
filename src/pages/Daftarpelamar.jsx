  ...
  return (
    <>
      <div className="container">
        <Header />
        <>
          {alertSuccess ? <AlertSucceed message={"Berhasil terikirm"} /> : null}
          ...
          >
            ...
            >
              ...
              {!loadingPage
                ? dataApplication
                    .filter(
                      (element) => element.id_application === Number(getId)
                    )
                    .map((e) => (
                      <div key={e.id_application} className="daftar-popup">
                        <div className="daftar-p-content">
                          ...
                          <div
                            onClick={() =>
                              nav(`/profil-pelamar/${e.id_pelamar}`)
                            }
                          ...
                          >
                            <span>
                              <img
                                src={
                                  e.profil ? e.profil : "/profil-pelamar.svg"
                                }
